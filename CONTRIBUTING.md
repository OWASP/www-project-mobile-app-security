...
Contributing to the website of the MSTG can be done in many different ways:

- **File [issues](https://github.com/OWASP/www-project-mobile-security-testing-guide/issues "Website Issues")** for missing content or errors. Explain what you think is missing and give a suggestion as to where it could be added.
- **Create a [Pull Request (PR)](https://github.com/OWASP/www-project-mobile-security-testing-guide/pulls "Create a pull request")**. This is a direct contribution to the guide and may be merged after review. You should ideally [create an issue](https://github.com/OWASP/www-project-mobile-security-testing-guide/ "Website Issues") for any PR you would like to submit, as we can first review the merit of the PR and avoid any unnecessary work. This is of course not needed for small modifications such as correcting typos.
...
In order to increase the chances of your PR being accepted, please make sure that the markdown is propperly formatted and links are working.
...
4. Go to the newly cloned directory "www-project-mobile-security-testing-guide" and add the remote upstream repository:

    ```bash
    $ git remote -v
    origin git@github.com:<your Github handle>/www-project-mobile-security-testing-guide.git (fetch)
    origin git@github.com:<your Github handle>/www-project-mobile-security-testing-guide.git (push)

    $ git remote add upstream git@github.com:OWASP/www-project-mobile-security-testing-guide.git

    $ git remote -v
    origin git@github.com:<your Github handle>/www-project-mobile-security-testing-guide.git (fetch)
    origin git@github.com:<your Github handle>/www-project-mobile-security-testing-guide.git (push)
    upstream git@github.com:OWASP/www-project-mobile-security-testing-guide.git (fetch)
    upstream git@github.com:OWASP/www-project-mobile-security-testing-guide.git (push)
    ```
...
5. Choose what to work on, based on any of the outstanding [issues](https://github.com/OWASP/www-project-mobile-security-testing-guide/issues "Website Issues").
6. Create a branch so that you can cleanly work on the chosen issue: `git checkout -b FixingIssue66`
7. Open your favorite editor and start making modifications. We recommend using the free [Visual Studio Code editor](https://code.visualstudio.com "Visual Studio Code") as it can make use of the code linting that is part of the repository through the [MarkdownLint plugin](https://github.com/DavidAnson/vscode-markdownlint#install "MarkdownLint plugin"). The code linter can help you when you make mistakes against our [style guide](https://github.com/OWASP/www-project-mobile-security-testing-guide/blob/master/style_guide.md "MSTG Style Guide"), but be sure to read the style guide yourself, as the code linter will only detect a part of it.
...
9. Create a Pull Request (PR) by going to your fork, <https://github.com/Your_Github_Handle/www-project-mobile-security-testing-guide> and click on the "New Pull Request" button. The target branch should typically be the Master branch. When submitting a PR, be sure to follow the checklist that is provided in the PR template. The checklist itself will be filled out by the reviewer.
...
Please be sure to take a careful look at our [Code of Conduct](https://github.com/OWASP/www-project-mobile-security-testing-guide/blob/master/CODE_OF_CONDUCT.md "Code of Conduct") for all the details.
